...
@section('title')
    Enrollment Management | Create Enrollment
@endsection

@section('contents')
    <div class="md:flex block items-center justify-between mb-6 mt-[2rem] page-header-breadcrumb">
        <div class="my-auto">
            <h5 class="page-title text-[1.3125rem] font-medium text-defaulttextcolor mb-0">Create Enrollment</h5>
            <nav>
        ...
        <div class="xl:col-span-12 col-span-12">
            <div class="box">
                <div class="box-header">
                    <div class="box-title">Create New Enrollment</div>
                </div>
                ...
                <div class="box-body">
                    ...
                    <form id="create-enrollment-form" method="POST" action="{{ route('enrollments.store') }}"
                            ...
                            <div class="xl:col-span-6 lg:col-span-6 md:col-span-6 sm:col-span-12 col-span-12 mb-4">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" id="school_year" name="school_year"
                                        value="{{ old('school_year') }}" placeholder="e.g., 2024-2025">
                                </div>
                            </div>
                            ...
                            <div class="xl:col-span-6 lg:col-span-6 md:col-span-6 sm:col-span-12 col-span-12 mb-4">
                                ...
                                <div class="input-group">
                                    <input type="date" class="form-control" id="date_enrolled" name="date_enrolled"
                                        value="{{ old('date_enrolled', \Carbon\Carbon::now()->format('Y-m-d')) }}" required>
                                </div>
                        ...
                        <div class="flex items-center justify-end gap-3 mt-4 pt-4 border-t border-defaultborder">
                            ...
                            <button type="submit" class="ti-btn ti-btn-primary-full ti-btn-wave">
                                <i class="ri-check-line me-1"></i> Enroll Student
                            </button>
                        </div>
    ...
    <script>
        ...
        document.getElementById('create-enrollment-form').addEventListener('submit', function(e) {
            e.preventDefault();
            const form = this;
            ...
            swalWithButtons.fire({
                ...
                text: 'Are you sure you want to save this new enrollment?',
                icon: 'question',
