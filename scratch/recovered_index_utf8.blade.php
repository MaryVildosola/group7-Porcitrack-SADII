                ...
                @if($pens->isNotEmpty())
                    ...
                    <div class="details-section">
                        ...
                        <div class="financial-row">
                            ...
                            <span class="financial-value">{{ $firstPen->batch_cost ?: 'Γé▒0' }}</span>
                        </div>
                        <div class="financial-row">
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        pensList.addEventListener('click', (e) => {
            ...
            if (data) {
                ...
                financialValues[0].innerText = data.batch_cost || 'Γé▒0';
                    ...
                    html: `
                        ...
                        <div class="form-grid">
                            ...
                            <div class="form-group">
                                ...
                                <input id="pen-batch-cost" class="custom-input" placeholder="e.g. Γé▒500,000">
                            </div>
                            <div class="form-group">
