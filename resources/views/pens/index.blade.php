...
@section('contents')
    ...
    <div id="assignTaskModal" class="custom-modal-overlay">
        <div class="custom-modal">
            ...
            <p style="color: #64748b; font-size: 0.85rem; margin-bottom: 28px;">Setting up a health check for <strong
                    id="task-pig-tag-display" style="color: var(--deep-slate);"></strong></p>
            <form id="assign-task-form">
                ...
                <div class="form-group">
                    ...
                    <textarea id="task-desc" name="description" class="form-input" style="height: 100px; resize: none;"
                        placeholder="What should the worker check? (e.g. Monitor appetite, Check leg wound, etc.)" required></textarea>
                </div>
                ...
                <button type="submit" id="task-submit-btn"
                    style="width: 100%; background: var(--accent-green); color: white; border: none; padding: 16px; border-radius: 16px; font-weight: 800; margin-top: 10px; cursor: pointer;">Assign
                    Task</button>
            </form>
        </div>
    </div>
