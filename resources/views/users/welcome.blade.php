            ...
            <div class="header-content-right">
                ...
                <div class="header-element !items-center">
                    ...
                    <div class="lg:hidden block">
                        ...
                        @else
                            <a href="{{ route('login') }}" class="ti-btn ti-btn-secondary !m-0">Log In</a>
                            <a href="{{ route('register') }}" class="ti-btn ti-btn-primary !m-0">Sign Up</a>
                        @endauth
                ...
                <div class="main-sidebar">
                    ...
                    <nav class="main-menu-container nav nav-pills flex-column sub-open">
                        ...
                        <div class="lg:flex hidden space-x-2 rtl:space-x-reverse">
                          ...
                          @else
                              <a href="{{ route('login') }}" class="ti-btn w-[6.375rem] ti-btn-secondary-full m-0 p-2">Log In</a>
                              <a href="{{ route('register') }}" class="ti-btn w-[6.375rem] ti-btn-primary-full m-0 p-2">Sign Up</a>
                          @endauth
                        ...
                        <div class="grid grid-cols-12 gap-x-6">
                            ...
                            <div class="xxl:col-span-8 xl:col-span-8 lg:col-span-8 md:col-span-8 col-span-10">
                                <div class="py-4 pb-lg-0 text-center">
                                    ...
                                    <a href="index.html" class="m-1 ti-btn ti-btn-info-full">
                                        Get Started
                            ...
                            <div class="">
                                <div class="feature-logos sm:mt-[3rem] flex-wrap">
                                    <div class="sm:ms-[3rem] ms-2 text-center">
                                        <img src="{{ asset('assets/images/media/landing/web/1.png') }}" alt="image"
                                            class="featur-icon">
                                        <h5 class="mt-3 text-white text-[1.25rem] ">Tailwind</h5>
                                    </div>
                                    <div class="sm:ms-[3rem] ms-2 text-center">
                                        <img src="{{ asset('assets/images/media/landing/web/2.png') }}" alt="image"
                                            class="featur-icon">
                                        <h5 class="mt-3 text-white text-[1.25rem] ">HTML5</h5>
                                    </div>
                                    <div class="sm:ms-[3rem] ms-2 text-center">
                                        <img src="{{ asset('assets/images/media/landing/web/3.png') }}" alt="image"
                                            class="featur-icon">
                                        <h5 class="mt-3 text-white text-[1.25rem] ">Sass</h5>
                                    </div>
                                    <div class="sm:ms-[3rem] ms-2 text-center">
                                        <img src="{{ asset('assets/images/media/landing/web/4.png') }}" alt="image"
                                            class="featur-icon">
                                        <h5 class="ms-3 text-white text-[1.25rem] ">Gulp</h5>
                                    </div>
                                    <div class="sm:ms-[3rem] ms-2 text-center">
                                        <img src="{{ asset('assets/images/media/landing/web/5.png') }}" alt="image"
                                            class="featur-icon">
                ...
                <div class="container text-center">
                    ...
                    <div class="grid grid-cols-12 justify-center items-center mx-0">
                        <div class="xxl:col-span-5 xl:col-span-5 lg:col-span-5 col-span-12 text-center">
                            <img src="{{ asset('assets/images/authentication/9.png') }}" alt="" class="img-fluid inline-flex">
                        </div>
                        <div
                ...
                <div class="container">
                    <div class="grid grid-cols-12 gap-x-6">
                        <div class="xl:col-span-4 lg:col-span-4 col-span-12">
                            <div class="px-6">
                                <p class="font-semibold mb-4"><a href="index.html"><img
                                            src="{{ asset('assets/images/brand-logos/desktop-dark.png') }}" alt=""></a></p>
